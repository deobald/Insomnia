...
Sub dixuInitSystem(ByVal Flags As Long, frm As Form, ByVal Width As Long, ByVal Height As Long, ByVal BitsPerPixel As Long)
...
Public Function DoubleChar(Num As Integer) As String
DoubleChar = Chr$(Num Mod 256) + Chr$(Int(Num / 256))
End Function
Public Function InteChar(St As String) As Integer
InteChar = Asc(Mid$(St, 1, 1)) + (Asc(Mid$(St, 2, 1)) * 256)
End Function
