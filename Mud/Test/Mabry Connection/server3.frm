...
Private Sub AsyncSocket1_OnAccept(ByVal SocketHandle As Long, ByVal ErrorCode As Integer)
    ...
    lstStatus.AddItem "Socket Address: " & foo.AsyncSocket1.SocketAddress
...
Dim MsgResponse, Msg1, Msg2, MsgAbout ' Dim the variables for the message box
